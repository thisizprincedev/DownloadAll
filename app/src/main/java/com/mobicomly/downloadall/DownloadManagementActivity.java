...
import in.mobicomly.download.activity.AppSettingActivity;
import in.mobicomly.download.activity.MagnetSearchActivity;
import in.mobicomly.download.activity.TorrentInfoActivity;
import in.mobicomly.download.activity.UrlDownLoadActivity;
...
public class DownloadManagementActivity extends BaseActivity implements DownloadManagementView{
    ...
    private SuperTextView appSettingClick;
    private SuperTextView magnetSearchClick;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appSettingClick = findViewById(R.id.open_setting);
        magnetSearchClick = findViewById(R.id.open_magnet_search);
        ...
        appSettingClick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(DownloadManagementActivity.this,AppSettingActivity.class);
                startActivity(intent);
            }
        });
        magnetSearchClick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(DownloadManagementActivity.this,MagnetSearchActivity.class);
                startActivity(intent);
